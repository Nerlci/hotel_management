...
- 以下是一位顾客的使用详单示例：
  ...
  **计算:**
  $$P_1=30\times\lvert32-26\rvert + 0.5\times2000 = 1.18\text{千瓦}$$
  
  **费用:**
  $$\text{费用}_1 = P_1 \times \text{使用时间} \times \text{电价} = 1.18 \times 3 \times 0.48 = 1.6992\text{元}$$
  ...
  **计算:**
  $$P_2=10\times\lvert29-26\rvert + 0.5\times2000 = 1.03\text{千瓦}$$
  
  **费用:**
  $$\text{费用}_2 = P_2 \times \text{使用时间} \times \text{电价} = 1.03 \times 13 \times 0.48 = 6.4272\text{元}$$
  
  ---
  
  **总费用:**
  $$\text{总费用} = \text{费用}_1 + \text{费用}_2 = 1.6992 + 6.4272 = 8.1264\text{元}$$
